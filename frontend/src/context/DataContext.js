      ...
      try {
        ...
        if (backendData) {
          setData({
            ...
            campusLinks: backendData.campusLinks?.map(l => typeof l === 'string' ? { text: l, url: '' } : { text: l.text || '', url: l.url || '' }) || [],
            facilityLinks: backendData.facilityLinks?.map(l => typeof l === 'string' ? { text: l, url: '' } : { text: l.text || '', url: l.url || '' }) || [],
            researchCards: backendData.researchCards || [],
            researchLinks: backendData.researchLinks?.map(l => typeof l === 'string' ? { text: l, url: '' } : { text: l.text || '', url: l.url || '' }) || [],
